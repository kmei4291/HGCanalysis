...
fOut=ROOT.TFile.Open('simpleMuonAnalysisTree_v2.root','RECREATE')
...
lvector=n.zeros(1,dtype=int)
ivector=n.zeros(1,dtype=int)

outputTree.Branch('d',dvector,'d/D')
outputTree.Branch('ct',tvector,'ct/D')
outputTree.Branch('layer',lvector,'layer/I') 
outputTree.Branch('index',ivector,'index/I') 
